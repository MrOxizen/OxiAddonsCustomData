...
class Single_Product extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_tab(
            'sa_el_static_product_btn_hover',
            [
        ...
        <div id="sa-el-single-product-<?php echo esc_attr($this->get_id()); ?>" class="sa-el-single-product">
            ...
            <div class="sa-el-single-product-details">
                <?php if (!empty($settings['sa_el_static_product_heading'])) : ?>
                    <h2><a href="<?php echo esc_attr($settings['sa_el_static_product_link_url']); ?>" target="<?php echo esc_attr($settings['sa_el_static_product_link_target']); ?>"><?php echo esc_attr($settings['sa_el_static_product_heading']); ?></a>
                    </h2>
                <?php endif; ?>
