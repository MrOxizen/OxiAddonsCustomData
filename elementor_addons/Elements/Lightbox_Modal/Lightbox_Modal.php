    ...
    protected function _register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '.sa_el_lightbox_popup_window_{{ID}}' => 'width: {{SIZE}}{{UNIT}} !important; max-width: {{SIZE}}{{UNIT}} !important',
                    '.sa_el_lightbox_modal_window_{{ID}}' => 'width: {{SIZE}}{{UNIT}} !important',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '.sa_el_lightbox_popup_window_{{ID}} .sa_el_lightbox_container' => 'height: {{SIZE}}{{UNIT}} !important',
                    '.sa_el_lightbox_popup_window_{{ID}}.lightbox_type_image .sa_el_lightbox_container img' => 'max-height: 100%; !important',
                ],
                'condition' => [
                    'auto_height!' => 'yes',
                    'layout_type' => 'standard',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '.sa_el_lightbox_popup_window.sa_el_lightbox_popup_window_{{ID}} .sa_el_lightbox_container' => 'background-color: {{VALUE}} !important;',
                    '.sa_el_lightbox_popup_window.sa_el_lightbox_modal_window_{{ID}} .sa_el_lightbox_container' => 'background-color: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'sa_el_section_lightbox_content_alignment',
            [
                'label' => esc_html__('Alignment', SA_ELEMENTOR_TEXTDOMAIN),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => true,
                ...
                'default' => 'Center',
                'selectors' => [
                    '.sa_el_lightbox_popup_window_{{ID}}.lightbox_type_content .sa_el_lightbox_container' => 'text-align: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                'selector' => '.sa_el_lightbox_popup_window_{{ID}} .sa_el_lightbox_container'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '.sa_el_lightbox_popup_window_{{ID}} .sa_el_lightbox_container' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selectors' => [
                    '.sa_el_lightbox_popup_window_{{ID}} .mfp-close' => 'color: {{VALUE}} !important',
                ],
                'condition' => [
                    'close_button' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '.sa_el_lightbox_popup_window_{{ID}} .mfp-close:hover' => 'color: {{VALUE}} !important',
                ],
                'condition' => [
                    'close_button' => 'yes',
                ],
