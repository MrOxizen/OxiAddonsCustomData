...
class Fancy_Text extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'default' => esc_html__('This is the ', SA_ELEMENTOR_TEXTDOMAIN),
            'dynamic' => ['active' => true]
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => [
                [
                    'sa_el_fancy_text_strings_text_field' => __('First string', SA_ELEMENTOR_TEXTDOMAIN),
                ],
                [
                    'sa_el_fancy_text_strings_text_field' => __('Second tring', SA_ELEMENTOR_TEXTDOMAIN),
                ],
                [
                    'sa_el_fancy_text_strings_text_field' => __('Third tring', SA_ELEMENTOR_TEXTDOMAIN),
                ]
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::TEXT,
            'default' => esc_html__(' of the sentence.', SA_ELEMENTOR_TEXTDOMAIN),
            'dynamic' => ['active' => true]
                ]
        );
        ...
        $this->add_control(
                'sa_el_fancy_text_style_pro_alert', [
            'label' => esc_html__('Only available in pro version!', SA_ELEMENTOR_TEXTDOMAIN),
            'type' => Controls_Manager::HEADING,
            'condition' => [
                'sa_el_fancy_text_style' => $style_options['conditions'],
            ]
                ]
        );
        ...
        $this->add_group_control(
            ...
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .sa_el_fancy_text_strings, {{WRAPPER}} .typed_cursor',
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .typed_cursor' => 'color: {{VALUE}};',
            ],
            'condition' => [
