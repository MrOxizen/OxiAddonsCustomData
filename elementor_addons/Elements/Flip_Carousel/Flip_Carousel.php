...
class Flip_Carousel extends Widget_Base {
	...
	// Loop Value
	if( 'true' == $settings['sa_el_flip_carousel_loop'] ) : $eael_loop = 'true'; else: $eael_loop = 'false'; endif;
	// Autoplay Value
	if( 'true' == $settings['sa_el_flip_carousel_autoplay'] ) : $eael_autoplay = $settings['sa_el_flip_carousel_autoplay_time']; else: $eael_autoplay = 'false'; endif;
	// Pause On Hover Value
	if( 'true' == $settings['sa_el_flip_carousel_pause_on_hover'] ) : $eael_pause_hover = 'true'; else: $eael_pause_hover = 'false'; endif;
	// Click Value
	if( 'true' == $settings['sa_el_flip_carousel_click'] ) : $eael_click = 'true'; else: $eael_click = 'false'; endif;
	// Scroll Wheel Value
	if( 'true' == $settings['sa_el_flip_carousel_scrollwheel'] ) : $eael_wheel = 'true'; else: $eael_wheel = 'false'; endif;
	// Touch Play Value
	if( 'true' == $settings['sa_el_flip_carousel_touch'] ) : $eael_touch = 'true'; else: $eael_touch = 'false'; endif;
	// Navigator Value
	if( 'true' == $settings['sa_el_flip_carousel_button'] ) : $eael_buttons = 'true'; else: $eael_buttons = 'false'; endif;
	if( 'true' == $settings['sa_el_flip_carousel_custom_nav'] ) : $eael_custom_buttons = 'custom';else: $eael_custom_buttons = ''; endif;
	// Start Value
	if( 'true' == $settings['sa_el_flip_carousel_start_from'] ) : $eael_start = 'center'; else: $eael_start = (int) $settings['sa_el_flip_carousel_starting_number']; endif;
	...
	<div class="sa_el_flip_carousel flip-carousel-<?php echo esc_attr( $this->get_id() ); ?>" data-style="<?php echo esc_attr( $settings['sa_el_flip_carousel_type'] ); ?>" data-start="<?php echo $eael_start; ?>" data-fadein="<?php echo esc_attr( (int) $settings['sa_el_flip_carousel_fade_in'] ); ?>" data-loop="<?php echo $eael_loop; ?>" data-autoplay="<?php echo $eael_autoplay; ?>" data-pauseonhover="<?php echo $eael_pause_hover; ?>" data-spacing="<?php echo esc_attr( $settings['sa_el_flip_carousel_spacing']['size'] ); ?>" data-click="<?php echo $eael_click; ?>" data-scrollwheel="<?php echo $eael_wheel; ?>" data-touch="<?php echo $eael_touch; ?>" data-buttons="<?php echo $eael_custom_buttons; ?>" data-buttonprev="<?php echo esc_attr( $settings['sa_el_flip_carousel_custom_nav_prev'] ); ?>" data-buttonnext="<?php echo esc_attr( $settings['sa_el_flip_carousel_custom_nav_next'] ); ?>">
	    <ul class="flip-items">
			...
			?>
		        <li>
		        	<?php if( 'true' == $slides['sa_el_flip_carousel_enable_slide_link'] ) :
