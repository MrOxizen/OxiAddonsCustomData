...
class Price_Menu extends Widget_Base {
    ...
    protected function render() {
        ...
        <# if ( item.menu_price !='' ) { #>
        <span class="sa_el_restaurant_menu_price">
            <# if ( item.discount=='yes' ) { var original_price=item.original_price; view.addRenderAttribute( 'menu_items.' + ($i - 1) + '.original_price' , 'class' , 'sa_el_restaurant_menu_price_original' ); view.addInlineEditingAttributes( 'menu_items.' + ($i - 1) + '.original_price' ); var original_price_html='<span' + ' ' + view.getRenderAttributeString( 'menu_items.' + ($i - 1) + '.original_price' ) + '>' + original_price + '</span>' ; print( original_price_html ); } var menu_price=item.menu_price; view.addRenderAttribute( 'menu_items.' + ($i - 1) + '.menu_price' , 'class' , 'sa_el_restaurant_menu_price_discount' ); view.addInlineEditingAttributes( 'menu_items.' + ($i - 1) + '.menu_price' ); var menu_price_html='<span' + ' ' + view.getRenderAttributeString( 'menu_items.' + ($i - 1) + '.menu_price' ) + '>' + menu_price + '</span>' ; print( menu_price_html ); #>
        </span>
        <# } #>
                                    <?php
                                }
                                ...
                                protected function _title_template() {
                                    ?>
        <# var title=item.menu_title; view.addRenderAttribute( 'menu_items.' + ($i - 1) + '.menu_title' , 'class' , 'sa_el_restaurant_menu_description' ); view.addInlineEditingAttributes( 'menu_items.' + ($i - 1) + '.menu_title' ); var title_html='<div' + ' ' + view.getRenderAttributeString( 'menu_items.' + ($i - 1) + '.menu_title' ) + '>' + title + '</div>' ; print( title_html ); #>
                                        <?php
                                    }
                                    ...
                                    protected function _content_template() {
                                        ?>
        <# var $i=1; #>
        <div class="sa_el_restaurant_menu sa_el_restaurant_menu_{{ settings.menu_style }}">
            <div class="sa_el_restaurant_menu_items">
                    ...
                    <div class="sa_el_restaurant_menu_item">
                        ...
                        <div class="sa_el_restaurant_menu_content">
                            <div class="sa_el_restaurant_menu_header">
                                ...
                                <# if ( settings.menu_style=='style_1' ) { #>
                <?php $this->_price_template(); ?>
                            ...
                            <# if ( item.menu_description !='' ) { var description=item.menu_description; view.addRenderAttribute( 'menu_items.' + ($i - 1) + '.menu_description' , 'class' , 'sa_el_restaurant_menu_description' ); view.addInlineEditingAttributes( 'menu_items.' + ($i - 1) + '.menu_description' ); var description_html='<div' + ' ' + view.getRenderAttributeString( 'menu_items.' + ($i - 1) + '.menu_description' ) + '>' + description + '</div>' ; print( description_html ); } #>
