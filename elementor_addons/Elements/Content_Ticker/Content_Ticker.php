<?php
namespace SA_ELEMENTOR_ADDONS\Elements\Content_Ticker;
...
class Content_Ticker extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Content Ticker', SA_ELEMENTOR_TEXTDOMAIN );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Ticker Settings', SA_ELEMENTOR_TEXTDOMAIN )
			]
		);
		...
		$ticker_options = apply_filters(
			...
			[
				'options'	=> [
					'dynamic'     => esc_html__( 'Dynamic', SA_ELEMENTOR_TEXTDOMAIN ),
					'custom'      => esc_html__( 'Custom', SA_ELEMENTOR_TEXTDOMAIN ),
				],
				'conditions'	=> [
					'custom'
				]
		...
		$this->add_control(
			'eael_ticker_type',
			[
				'label'       => esc_html__( 'Ticker Type', SA_ELEMENTOR_TEXTDOMAIN ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Custom Content available in pro version only!', SA_ELEMENTOR_TEXTDOMAIN ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Tag Text', SA_ELEMENTOR_TEXTDOMAIN ),
				'type' => Controls_Manager::TEXT,
				'label_block' => false,
				'default' => esc_html__( 'Trending Today', SA_ELEMENTOR_TEXTDOMAIN ),
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label'                 => __( 'Animation Settings', SA_ELEMENTOR_TEXTDOMAIN ),
            ]
        );
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Ticker Content', SA_ELEMENTOR_TEXTDOMAIN ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Text Hover Color', SA_ELEMENTOR_TEXTDOMAIN ),
				'type' => Controls_Manager::COLOR,
				'default' => '#f44336',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tag Style', SA_ELEMENTOR_TEXTDOMAIN ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		$this->add_control(
	...
	protected function render( ) {
		...
		$this->add_render_attribute( 'content-ticker', 'class', 'swiper-container sa_el_content_ticker' );
						...
						<?php 
							if( 'dynamic' === $settings['eael_ticker_type'] ) {
								if( ! empty( $posts['content'] ) ) {
									...
									echo ' <div class="swiper-slide"><a href="#" class="ticker-content">'. __( 'Something went wrong!', SA_ELEMENTOR_TEXTDOMAIN ) .'</a></div>';
								}
							}
