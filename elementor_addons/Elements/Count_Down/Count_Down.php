...
class Count_down extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Countdown', SA_ELEMENTOR_TEXTDOMAIN );
	}
   ...
   public function get_categories() {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'condition' => [
					'eael_countdown_label_view' => 'sa_el_countdown-label-inline',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'condition' => [
					'eael_countdown_separator' => 'sa_el_countdown-show-separator',
				],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'default'		=> esc_html__('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s',SA_ELEMENTOR_TEXTDOMAIN),
				'condition'		=> [
					'countdown_expire_type' => 'text'
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div' => 'margin-right:{{SIZE}}px; margin-left:{{SIZE}}px;',
					'{{WRAPPER}} .sa_el_countdown-container' => 'margin-right: -{{SIZE}}px; margin-left: -{{SIZE}}px;',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-container' => 'margin-bottom:{{SIZE}}px;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .sa_el_countdown-item > div',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div.sa_el_countdown-days' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-days .sa_el_countdown-digits' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-days .sa_el_countdown-label' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div.sa_el_countdown-days' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div.sa_el_countdown-hours' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-hours .sa_el_countdown-digits' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-hours .sa_el_countdown-label' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div.sa_el_countdown-hours' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div.sa_el_countdown-minutes' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-minutes .sa_el_countdown-digits' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-minutes .sa_el_countdown-label' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div.sa_el_countdown-minutes' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-item > div.sa_el_countdown-seconds' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-seconds .sa_el_countdown-digits' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors'	=> [
					'{{WRAPPER}} .sa_el_countdown-seconds .sa_el_countdown-label' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' 	=> '',
				'selectors'	=> [
					'{{WRAPPER}} .sa_el_countdown-item > div.sa_el_countdown-seconds' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'left',
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-finish-message' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors'	=> [
					'{{WRAPPER}} .sa_el_countdown-finish-message .expiry-title' => 'color: {{VALUE}};',
				],
				'condition'	=> [
					'countdown_expire_type' => 'text',
				],
		...
		$this->add_group_control(
			...
			[
             'name'			=> 'eael_countdown_expire_title_typography',
				'scheme'	=> Scheme_Typography::TYPOGRAPHY_2,
				'selector'	=> '{{WRAPPER}} .sa_el_countdown-finish-message .expiry-title',
				'condition'	=> [
					'countdown_expire_type' => 'text',
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .sa_el_countdown-finish-message .expiry-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '',
				'selectors'	=> [
					'{{WRAPPER}} .sa_el_countdown-finish-text' => 'color: {{VALUE}};',
				],
				'condition'	=> [
					'countdown_expire_type' => 'text',
				],
		...
		$this->add_group_control(
			...
			[
             'name'			=> 'eael_countdown_expire_message_typography',
				'scheme'	=> Scheme_Typography::TYPOGRAPHY_2,
				'selector'	=> '.sa_el_countdown-finish-text',
				'condition'	=> [
					'countdown_expire_type' => 'text',
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator'		=> 'before',
				'selectors'		=> [
					'{{WRAPPER}} .sa_el_countdown-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'countdown_expire_type' => 'text',
				],
	...
	protected function render( ) {
      ...
      $settings = $this->get_settings();
		...
		$this->add_render_attribute( 'sa_el_countdown', 'class', 'sa_el_countdown-wrapper' );
	...
	<div <?php echo $this->get_render_attribute_string( 'sa_el_countdown' ); ?>>
		<div class="sa_el_countdown-container <?php echo esc_attr($settings['eael_countdown_label_view'] ); ?> <?php echo esc_attr($settings['eael_countdown_separator'] ); ?>">
			<ul id="sa_el_countdown-<?php echo esc_attr($this->get_id()); ?>" class="sa_el_countdown-items <?php echo esc_attr( $eael_countdown_style ); ?>" data-date="<?php echo esc_attr($due_date) ; ?>">
			    <?php if ( ! empty( $settings['eael_countdown_days'] ) ) : ?><li class="sa_el_countdown-item"><div class="sa_el_countdown-days"><span data-days class="sa_el_countdown-digits">00</span><?php if ( ! empty( $settings['eael_countdown_days_label'] ) ) : ?><span class="sa_el_countdown-label"><?php echo esc_attr($settings['eael_countdown_days_label'] ); ?></span><?php endif; ?></div></li><?php endif; ?>
			    <?php if ( ! empty( $settings['eael_countdown_hours'] ) ) : ?><li class="sa_el_countdown-item"><div class="sa_el_countdown-hours"><span data-hours class="sa_el_countdown-digits">00</span><?php if ( ! empty( $settings['eael_countdown_hours_label'] ) ) : ?><span class="sa_el_countdown-label"><?php echo esc_attr($settings['eael_countdown_hours_label'] ); ?></span><?php endif; ?></div></li><?php endif; ?>
			   <?php if ( ! empty( $settings['eael_countdown_minutes'] ) ) : ?><li class="sa_el_countdown-item"><div class="sa_el_countdown-minutes"><span data-minutes class="sa_el_countdown-digits">00</span><?php if ( ! empty( $settings['eael_countdown_minutes_label'] ) ) : ?><span class="sa_el_countdown-label"><?php echo esc_attr($settings['eael_countdown_minutes_label'] ); ?></span><?php endif; ?></div></li><?php endif; ?>
			   <?php if ( ! empty( $settings['eael_countdown_seconds'] ) ) : ?><li class="sa_el_countdown-item"><div class="sa_el_countdown-seconds"><span data-seconds class="sa_el_countdown-digits">00</span><?php if ( ! empty( $settings['eael_countdown_seconds_label'] ) ) : ?><span class="sa_el_countdown-label"><?php echo esc_attr($settings['eael_countdown_seconds_label'] ); ?></span><?php endif; ?></div></li><?php endif; ?>
			</ul>
