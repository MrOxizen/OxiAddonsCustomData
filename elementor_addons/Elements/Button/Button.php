...
class Button extends Widget_Base
{
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'options'     => [
					...
					'sa_el_creative_button_wayra' 		=> esc_html__('Wayra', 	SA_ELEMENTOR_TEXTDOMAIN),
					'sa_el_creative_button_tamaya' 		=> esc_html__('Tamaya', 	SA_ELEMENTOR_TEXTDOMAIN),
					'sa_el_creative_button_rayen' 		=> esc_html__('Rayen', 	SA_ELEMENTOR_TEXTDOMAIN),
					'sa_el_creative_button_shutter' 	=> esc_html__('Shutter', 	SA_ELEMENTOR_TEXTDOMAIN),
				],
		...
		$this->add_control(
			...
			[
				...
				'default'       => 'shutouthor',
				'options'       => [
					'shutinhor'     => __('Shutter in Horizontal', SA_ELEMENTOR_TEXTDOMAIN),
					'shutinver'     => __('Shutter in Vertical', SA_ELEMENTOR_TEXTDOMAIN),
					'shutoutver'    => __('Shutter out Horizontal', SA_ELEMENTOR_TEXTDOMAIN),
					'shutouthor'    => __('Shutter out Vertical', SA_ELEMENTOR_TEXTDOMAIN),
					'scshutoutver'  => __('Scaled Shutter Vertical', SA_ELEMENTOR_TEXTDOMAIN),
					'scshutouthor'  => __('Scaled Shutter Horizontal', SA_ELEMENTOR_TEXTDOMAIN),
					'dshutinver'   => __('Tilted Left', SA_ELEMENTOR_TEXTDOMAIN),
					'dshutinhor'   => __('Tilted Right', SA_ELEMENTOR_TEXTDOMAIN),
				],
				'condition'     => [
	...
	protected function render()
	{
		...
		if ($settings['creative_button_effect'] == 'sa_el_creative_button_default') {
			...
			$style_class = $settings['creative_button_effect'];
		} elseif ($settings['creative_button_effect'] == 'sa_el_creative_button_wayra') {
			$style_class = $settings['creative_button_effect'];
		} elseif ($settings['creative_button_effect'] == 'sa_el_creative_button_tamaya') {
			$style_class = $settings['creative_button_effect'];
		} elseif ($settings['creative_button_effect'] == 'sa_el_creative_button_rayen') {
			$style_class = $settings['creative_button_effect'];
			...
			<a class="sa_el_creative_button <?php echo esc_attr($style_class); ?>" <?php echo $this->get_render_attribute_string('sa_el_creative_button'); ?>>
				<span>
					...
					<?php if (!empty($settings['sa_el_creative_button_icon']) && $settings['sa_el_creative_button_icon_alignment'] == 'right') : ?>
						<i class="<?php echo esc_attr($settings['sa_el_creative_button_icon']); ?> sa_el_creative_button_icon_right" aria-hidden="true"></i>
					<?php endif; ?>
				</span>
			</a>
		</div>
