...
/*=================================*/
var SaElTeamMemberCarouselHandler = function($scope, $) {
    var $carousel = $scope.find(".sa-el-tm-carousel").eq(0),
        $pagination =
        $carousel.data("pagination") !== undefined ?
        $carousel.data("pagination") :
        ".swiper-pagination",
...
jQuery(window).on("elementor/frontend/init", function() {
    elementorFrontend.hooks.addAction(
        "frontend/element_ready/sa-el-team-member-carousel.default",
        SaElTeamMemberCarouselHandler
    );
});/*=================================*/
/*  Testimonial Slider
/*=================================*/
var SaElTestimonialSliderHandler = function($scope, $) {
    var $testimonialSlider = $scope.find(".sa-el-testimonial-slider-main").eq(0),
        $pagination =
...
jQuery(window).on("elementor/frontend/init", function() {
    elementorFrontend.hooks.addAction(
        "frontend/element_ready/sa-el-testimonial-slider.default",
        SaElTestimonialSliderHandler
    );
});/*=================================*/
/*  Toggle
/*=================================*/
