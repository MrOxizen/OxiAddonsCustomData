...
jQuery(window).on("elementor/frontend/init", function() {
    ...
    $.fn.saelProgressBar = function() {
        ...
        a.one("inview", function() {
            "line" == i ? $(".sa-el-progressbar-line-fill", a).css({ width: e + "%" }) : "half_circle" == i && $(".sa-el-progressbar-circle-half", a).css({ transform: "rotate(" + 1.8 * e + "deg)" }), $(".sa-el-progressbar-count", a).prop({ counter: 0 }).animate({ counter: e }, {                duration: r,
                easing: "linear",
                step: function(e) {
                    if ("circle" == i) {
                        var r = 3.6 * e;
