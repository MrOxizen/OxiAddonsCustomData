	...
	SAOffcanvasContent.prototype = {
		...
		init: function () {
			...
			if ( this.wrap.find('.sa-el-offcanvas-content').length > 0 ) {
				if ( 'push' === this.transition ) {
					if ( $('.sa-el-offcanvas-container > .sa-el-offcanvas-content-' + this.id).length > 0 ) {
						$('.sa-el-offcanvas-container > .sa-el-offcanvas-content-' + this.id).remove();
					}
					$('.sa-el-offcanvas-container').prepend( this.wrap.find('.sa-el-offcanvas-content') );
				} else {
					if ( $('.sa-el-offcanvas-container > .sa-el-offcanvas-content-' + this.id).length > 0 ) {
						$('.sa-el-offcanvas-container > .sa-el-offcanvas-content-' + this.id).remove();
					}
		...
		bindEvents: function () {
			...
			$('body').delegate( '.sa-el-offcanvas-content .sa-el-offcanvas-close', 'click', $.proxy( this.close, this ) );
		...
		show: function() {
			$('.sa-el-offcanvas-content-' + this.id).addClass('sa-el-offcanvas-content-visible');
		...
		close: function() {
			...
			setTimeout($.proxy(function () {
				...
				$('.sa-el-offcanvas-content-' + this.id).removeClass('sa-el-offcanvas-content-visible');
			}, this), 500);
		},
		...
		closeClick: function() {
			...
			$(document).on('click', function(e) {
				if ( $(e.target).is('.sa-el-offcanvas-content') || $(e.target).parents('.sa-el-offcanvas-content').length > 0 || $(e.target).is('.sa-el-offcanvas-toggle') || $(e.target).parents('.sa-el-offcanvas-toggle').length > 0 ) {
					return;
				} else {
					self.close();
				}
