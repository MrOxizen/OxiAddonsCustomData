...
/*
 * TrapTabKey
 * Based on https://github.com/gdkraus/accessible-modal-dialog/blob/master/modal-window.sa
...
(function( w, $ ){
	...
	var pluginName = "saButton",
		initSelector = ".sa-button";
...
;(function( window, $ ){
	...
	Offcanvas.prototype.defaults = {
		...
		closeButtonClass: "sa-offcanvas-close",
...
(function( w, $ ){
	...
	var pluginName = "offcanvasTrigger",
		initSelector = "[data-offcanvas-trigger],.sa-" + pluginName;
