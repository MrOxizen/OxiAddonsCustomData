...
class price_table extends FLBuilderModule
{

    public function __construct()
    {
        parent::__construct(array(
            'name' => __('Price Table', SA_FLBUILDER_TEXTDOMAIN),
            ...
            'dir' => FL_MODULE_SA_FLBUILDER_URL . 'modules/sa-price-table',
            'url' => FL_MODULE_SA_FLBUILDER_URL . 'modules/sa-price-table',
            'icon' => 'info.svg',
        ));
...
require_once FL_MODULE_SA_FLBUILDER_URL . 'modules/sa-price-table/price-table-register.php';
